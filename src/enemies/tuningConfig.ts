...
export const ENEMY_TUNING: Record<string, EnemyTuning> = {
  poo: { anim: { swingRate: 2.6, legSwing: 0.45, armSwing: 0.5, headYaw: 0.7, headPitch: 0.7, bobRate: 3.2, bob: 0.18, squash: 0.28, rock: 0 }, height: 0.914, gameplay: { speedMult: 1, visionMult: 1, hearingMult: 1, threatMult: 1, scaleMult: 1 } },
